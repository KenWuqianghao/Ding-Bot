...
def initialize_engine():
    ...
    # This file is for the base-advanced-opening branch - prioritize BASE_ADVANCED models
    BRANCH_NAME = 'base-advanced-opening'
    hf_download_priority = ['BASE_ADVANCED']  # Will match both openings and regular BASE_ADVANCED
    ...
    if os.path.exists(model_dir):
        ...
        if not model_path:
            ...
            if base_models:
                ...
                print(f"✓ [BRANCH: base-advanced-opening] Using BASE_ADVANCED: {base_models[0]}")
        ...
        # Priority 3: Fallback to most recent .pth file (only if no BASE_ADVANCED found)
        if not model_path:
        ...
        if model_dir == ding_bot_model_dir and HUGGINGFACE_MODEL_REPO:
            ...
            try:
                ...
                if downloaded_path and os.path.exists(downloaded_path):
                    ...
                    if not model_path:
                        # Use downloaded model only if no BASE_ADVANCED found
